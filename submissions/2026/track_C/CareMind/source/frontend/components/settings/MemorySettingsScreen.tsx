...
function eventLabel(name: AnalyticsEvent["name"]) {
  const labels: Record<AnalyticsEvent["name"], string> = {
    ...
    privacy_cloud_consent_prompted: "云端处理确认已提示",
    privacy_cloud_consent_granted: "云端处理确认已同意",
    privacy_cloud_consent_denied: "云端处理确认已拒绝",
    privacy_local_first_blocked_network: "本地优先已拦截网络处理",
